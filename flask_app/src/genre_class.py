...
class GenreClassifier:
    def __init__(self):
        # self.data = pd.read_csv("rec_dataset.csv")
    ...
    def load_model(self, model_choice=1):
        model_filenames = {
            ...
            1: '../data/models/GenreClassModel/rf_model1.joblib',  # Filename for random forest model
        }
        # Access these from bash script
        scaler_filename = '../data/models/GenreClassModel/scaler1.joblib'  # Filename for scaler
        encoder_filename = '../data/models/GenreClassModel/encoder1.joblib'  # Filename for label encoder
        features_filename = '../data/models/GenreClassModel/features1.joblib'  # Filename for features

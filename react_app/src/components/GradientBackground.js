...
const GradientBackground = () => {
  return (
    ...
    <div className="gradient-background absolute top-[55%] left-[105%] lg:top-[5%] lg:left-[5%] w-full h-full flex justify-start items-center">
      <svg className="blur-[80px] " width="700" height="700" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">

...
function GradientBackground({ className }) {
  return (
    ...
    {/* <div className="gradient-background fixed top-[55%] right-[75%] lg:top-[0%] lg:right-[0%] w-full h-full flex justify-start items-center">
      ...
      <div className={`gradient-background absolute top-[-20%] left-[9%] lg:top-[-8%] lg:left-[9%] w-full h-full flex justify-start items-center ${className}`}>      <svg className="blur-[80px] " width="700" height="700" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">

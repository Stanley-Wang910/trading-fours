...
function GradientBackground({ className }) {
  return (
    <>
      <div className="gradient-background fixed top-[55%] left-[105%] lg:top-[55%] lg:left-[95%] w-full h-full flex justify-start items-center z-10">
        <svg
      ...
      <div
        className={`gradient-background absolute top-[-10%] left-[9%] lg:top-[-12%] lg:left-[9%] w-full h-full flex justify-start items-center ${className}`}
      >
        <svg
          className="blur-[75px] "
          width="700"

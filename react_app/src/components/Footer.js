...
const Footer = () => {
  ...
  return (
    <>
      <footer id="footer" 
        className="mt-[10vh] z-[50] w-full h-[240px] flex flex-row justify-between items-center px-[2vw] py-20 relative text-gray-400 ">
        ...
        <div className="col col1 flex flex-col items-start justify-start p-4 w-[28%]">
          <div className="relative translate-y-14 flex items-center before:content-[''] before:absolute before:top-[-50px] before:left-[-5px] before:w-[40px] before:h-[2px] before:bg-gray-400">
            ...
            <button onClick={handleScrollToTop} className="svg-short mb-2  justify items-col over">
                <svg className="absolute top-0" width="11" height="21" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
